...
type Validator interface {
	...
	ValidateTxProof(txProof [][]byte, txList []tx.Transaction) (bool, error)
	ValidateTransaction(txProof [][]byte, transaction tx.Transaction) (bool, error)
	BuildProofAndTxProof(txList []tx.Transaction) ([]byte, [][]byte, error)
}
